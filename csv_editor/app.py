                ...
                while(string != ""):
                    ...
                    if(third != "" and string.find(third) != -1):
                        ...
                        if(string.find(first) == -1 or string.find(second) == -1):
                            ...
                            print(cell)
                            # if(splitcheck1 == -1 and splitcheck2 != -1):
                            #     df.loc[index, "default-name"+str(columnnamecounter)] = str(cell)
                            #     columnnamecounter += 1
                            #     df.loc[index, "default-name"+str(columnnamecounter)] = columnmake
                            #     columnnamecounter += 1
                            # elif(splitcheck1 != -1 and splitcheck2 == -1):
                            #     df.loc[index, "default-name"+str(columnnamecounter)] = str(cell)
                            #     columnnamecounter += 1
                            #     df.loc[index, "default-name"+str(columnnamecounter)] = columnmake
                            #     columnnamecounter += 1
